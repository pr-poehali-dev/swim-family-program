...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-cyan-50 via-blue-50 to-white">
      ...
      <section id="kids-photos-2" className="py-20 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 text-gray-800">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <Card className="hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  "Дети занимаются уже год. Очень довольны. Младший вообще не мог держаться на воде. Сейчас уверенно плавает. Старший освоил разные стили. Есть занятия в группах, есть индивидуальные. Хорошая организация занятий, постоянно на связи, быстро решаются вопросы."
                </p>
                <p className="font-semibold text-gray-800">Александр Гатилин</p>
              </CardContent>
            </Card>
          </div>
